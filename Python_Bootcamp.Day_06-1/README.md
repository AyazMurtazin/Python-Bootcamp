...
Need to represent these limitations as Pydantic data types (see Reading section).
...
Name could be "Unknown" ONLY for enemy
ships.
...
Now project will have to include "reporting_client_v3.py" script which is responsible
...
Another case that colonel asked to implement was searching for "traitors". Sometimes the same
